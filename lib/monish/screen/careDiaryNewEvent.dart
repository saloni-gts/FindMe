...
class EventCalender extends StatefulWidget {
  ...
  bool isBottomBorder;
  bool isFromPet;
  EventCalender({Key? key,this.isShowBackIcon = true,this.isBottomBorder=true,this.isFromPet=true}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: MycustomAppbar
        ...
        isbackbutton:
        widget.isShowBackIcon ? true : false,
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                unselectedLabelStyle:
                    TextStyle(fontSize: 16, fontFamily: AppFont.poppinsMedium),
                labelStyle:
                    TextStyle(fontSize: 16, fontFamily: AppFont.poppinsMedium),
