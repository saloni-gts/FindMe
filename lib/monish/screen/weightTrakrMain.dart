...
class _WeightTrkrMainState extends State<WeightTrkrMain> {
  ...
  TextEditingController healthWehtController = new TextEditingController();
...
if(petProvider.petHealtweightCntrolr.text!=null) {
 dt = double.parse(petProvider.petHealtweightCntrolr.text);
  print("value of dt===>>> ${dt}");
    ...
    if (petProvider.priorWeight == null) {
      petProvider.priorWeight = 0.0;
    }

    if (petProvider.healthyWeight == null) {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Consumer2<Myprovider, PetProvider>(
                                  builder: (context, Pro, petProvider, child) {
                                                    ...
                                                    return Padding(
                                                      ...
                                                      child: InkWell(
                                                          onTap: () {
                                                            ...
                                                            petProvider.showContBorder(petProvider.weightList[index].id??0);


                                                            print(
                                                                "index of the weight list=== ${index}");
                                                            ...
                                                            petWeightController
                                                                ...
                                                                "";
                                                            print(
                                                                "weight healthy===>>> ${healthWehtController.text}");

                                                            petProvider.setChangeWeight(petProvider.weightList[index], index, double.parse(petProvider.petHealtweightCntrolr.text)
                                                            );
                                                          },
                                                          child: Stack(
                                                            children: [
                                                              ...
                                                              petProvider.weightList[index].id==petProvider.selectedWeightCont?
                                                              Center(
                                                                child: Container(
                                                                  height: 60,
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: Center(
                                                                  child: WeightFeild(context, petProvider.weightList[index].weight ?? 0,
                                                                      petProvider.weightList[index].date.toString(), index,
                                                                      petProvider.weightList[index].id ?? 0),
                                                                ),
                                                              ),
                                                          ...
                                                          builder: (context,petProvider,child) {
                                                            return LineChart(
                                                                ...
                                                                LineChartData(
                                                                    ...
                                                                    lineTouchData:
                                                                        LineTouchData(
                                                                            getTouchedSpotIndicator: (LineChartBarData
                                                                                    barData,
                                                                                List<int>
                                                                                    spotIndexes) {
                                                                              return spotIndexes
                                                                        ...
                                                                        petProvider.isCheckNext(petProvider.weightList[spotIndex], spotIndex, double.parse(petProvider.petHealtweightCntrolr.text));
                                          ...
                                          onTap: () {
                                            ...
                                            print("value of cntroler=>${petProvider.petHealtweightCntrolr.text}");
                                             ...
                                             if(petProvider.petHealtweightCntrolr.text.isNotEmpty) {
                                              ...
                                              petProvider.setChangeWeight(petProvider.weightList[setIndexVal], setIndexVal, double.parse(petProvider.petHealtweightCntrolr.text));

                                              petProvider.isCheckNext(petProvider.weightList[setIndexVal], setIndexVal, double.parse(petProvider.petHealtweightCntrolr.text));
                                            ...
                                            if(petProvider.petHealtweightCntrolr.text=="0" || petProvider.petHealtweightCntrolr.text=="0.0"|| petProvider.petHealtweightCntrolr.text=="0.00" || petProvider.petHealtweightCntrolr.text=="0000"||
                                                petProvider.petHealtweightCntrolr.text=="00.0" || petProvider.petHealtweightCntrolr.text=="00"|| petProvider.petHealtweightCntrolr.text=="000")
                                            {
                                              CoolAlert.show(
                                                  context: context, type: CoolAlertType.error, text: tr(LocaleKeys.additionText_plsNtrVldWght));
                                          ...
                                          child: Padding(
                                            ...
                                            child: Container(
                                              decoration: BoxDecoration(
                                                borderRadius: BorderRadius.circular(28.0),
                                                color:
                                                petProvider.petHealtweightCntrolr.text=="0.0" && petProvider.petHealtweightCntrolr.text.isEmpty?
                                              ...
                                              child: Center(
                                                child: Text(
                                                    ...
                                                    tr(LocaleKeys.additionText_capSave):tr(LocaleKeys.additionText_capUpdte),
          ...
          children: [
            Padding(
              ...
              child: customBlueButton(
                  context: context,
                  text1: tr(LocaleKeys.additionText_addNewRecCap),
