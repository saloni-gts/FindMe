...
class JntMgtCntrePikr extends StatefulWidget {
  final TextEditingController? phoneNumController;
  const JntMgtCntrePikr({Key? key, this.phoneNumController}) : super(key: key);

  @override
  State<JntMgtCntrePikr> createState() => _JntMgtCntrePikrState();
}

class _JntMgtCntrePikrState extends State<JntMgtCntrePikr> {
