                                ...
                                InkWell(
                                  ...
                                  onTap: () {
                                    ...
                                    petProvider.deleteNotesApiCall(
                                        context: context,
                                        idddd:
                                            petProvider.selectedNotes?.id ?? 0);
                                  },
                                )
                              ],
                            );
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl:
                                  petProvider.selectedNotes?.petPhoto??"",
                              fit: BoxFit.cover,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            Text(
                                  "${ tr(LocaleKeys.additionText_notesTitle)}"+" : ",
                                  maxLines: 5,
                              ...
                              Text(
                                  petProvider.selectedNotes?.title ?? "",
                                  maxLines: 5,
                                  overflow: TextOverflow.ellipsis,
                                  softWrap: true,
                                  textAlign: TextAlign.left,
                                    ...
                                    return
                                      ...
                                      child: InkWell(
                                          ...
                                          Navigator.push(
                                              ...
                                              MaterialPageRoute(
                                                  builder: (context) => PreviewFullImage2(
                                                    ...
                                                    isImage: noteImg[index].url?.split(".").last=="pdf" ? false:true,
                                                  )
                                              )
                                          );
                                          print("*************++++++++++++");
                                        ...
                                        child: Container(
                                          ...
                                          width: 100,
                                          child:
                                          noteImg[index].url?.split(".").last=="pdf" ?
                                          ClipRRect(
...
String dateConverter2(DateTime date,) {
