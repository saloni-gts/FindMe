...
import 'blur_background.dart';
 ...
 void cngPasswordDialog({required BuildContext context}) {
  ...
  TextEditingController newPassController=TextEditingController();
      ...
      showDialog(context: context, builder: (context)=>blurView(
    child:AlertDialog(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: CustomTextFieldWithLeading(textController: oldPassController,isPassword: true,onChanged: (v){}),
                      ),
                      ...
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 8.0),
                        child: CustomTextFieldWithLeading(textController: newPassController,isPassword: true,onChanged: (v){}),
                      ),
                     ...
                     // customBlueButton(context: context,colour: AppColor.textLightBlueBlack,text1: "SUBMIT",onTap1: (){})
                      ...
                      customSmallBlueButton(
                        ...
                        if(oldPassController.text.isEmpty||newPassController.text.isEmpty){
                          CoolAlert.show(context: context, type: CoolAlertType.warning,text: tr(LocaleKeys.additionText_entrBothPass));
