                ...
                Column(
                  ...
                  children: [
                        ...
                        children: [
                          InkWell(
                            ...
                            splashFactory: NoSplash.splashFactory,
                              child: Image.asset(
                                petProvider.SheildList==1 ? AppImage.upLeftSS : AppImage.upLefttIcon
                    ...
                    petProvider.isSheildComplete==1?
                        Image.asset(AppImage.goldSheild):SizedBox(),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SheildListPetInfo(txt1:  tr(LocaleKeys.additionText_petname), isCheck: petProvider.selectedPetDetail?.petName==""? 0:1,onTap1: (){
                            // petProvider.callGetQrTag();
                          ...
                          SheildListPetInfo(txt1:tr(LocaleKeys.additionText_birthday), isCheck: petProvider.selectedPetDetail?.birthDate=="" ?0:1,onTap1: (){
                          ...
                          SheildListPetInfo(txt1:tr(LocaleKeys.additionText_color), isCheck: petProvider.selectedPetDetail?.color==""? 0:1,onTap1: (){
                            Future.delayed(const Duration(milliseconds: 250), () {
                              petProvider.updateLoader(false);
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>PetProfile()) );
                            });
                          }),
                          SheildListPetInfo(txt1: tr(LocaleKeys.additionText_sex), isCheck:petProvider.selectedPetDetail?.gender==""?0: 1,onTap1: (){
                            Future.delayed(const Duration(milliseconds: 250), () {
                              petProvider.updateLoader(false);
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>PetProfile()) );
                            });
                          }),
                          SheildListPetInfo(txt1: tr(LocaleKeys.additionText_Breed), isCheck:petProvider.selectedPetDetail?.breedName==""? 0:1,onTap1: (){
                            Future.delayed(const Duration(milliseconds: 250), () {
                              petProvider.updateLoader(false);
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>PetProfile()) );
                            });
                          }),
                          SheildListPetInfo(txt1: tr(LocaleKeys.addPet_sterilization), isCheck: petProvider.selectedPetDetail?.sterilization=="1" ?1:0,onTap1: (){
                            Future.delayed(const Duration(milliseconds: 250), () {
                              petProvider.updateLoader(false);
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>PetProfile()));
                            });
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SheildListPetInfo(txt1: tr(LocaleKeys.additionText_fstName), isCheck: user.name=="" ? 0: 1,onTap1: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>OwnerProfile()));

                          }),
                          SheildListPetInfo(txt1: tr(LocaleKeys.additionText_Gender), isCheck:user.gender=="1"|| user.gender=="2"?1: 0,onTap1: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>OwnerProfile()));

                          }),
                          SheildListPetInfo(txt1: tr(LocaleKeys.additionText_Email), isCheck: 1,onTap1: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>OwnerProfile()));

                          }),
                          SheildListPetInfo(txt1:tr(LocaleKeys.additionText_MainPhn), isCheck: 1,onTap1: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>OwnerProfile()));

                          }),
                          SheildListPetInfo(txt1: tr(LocaleKeys.additionText_Country), isCheck: user.country==" "? 0:1,onTap1: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>OwnerProfile()));
                          }),
                        ],
                      ),
                              ...
                              RichText(
                                ...
                                text: TextSpan(children: <TextSpan>[
                                  TextSpan(
                                    ...
                                    tr(LocaleKeys.additionText_activateqr):  tr(LocaleKeys.additionText_qractivated),
                                    style: TextStyle(
                                        color: AppColor.textLightBlueBlack,
                                        fontSize: 16,
                                        fontWeight: FontWeight.w800),
                            ...
                            child: Column(
                              children: [
                                ...
                                RichText(
                                  ...
                                  tr(LocaleKeys.additionText_registerpetmicrochip) :  tr(LocaleKeys.additionText_microchipregisterd),
                                      style: TextStyle(
                                          color: AppColor.textLightBlueBlack,
                                          fontSize: 16,
                                          fontWeight: FontWeight.w800),
