                        ...
                        : Row(
                            children: [
                              ...
                              SizedBox(
                                width: MediaQuery.of(context).size.width * .85,
                                child: Text(
                                  "${tr(LocaleKeys.additionText_eventCategoryName)} : ${eventCateTypeController.text}",
                                  // petProvider.selectedEvent?.eventName ?? "",
                                  maxLines: 5,
                                  softWrap: true,
                                  textAlign: TextAlign.left,
                    ...
                    petProvider.editpetRepeatEvent.text == "Never"
                        ...
                        : Row(
                            children: [
                              ...
                              Text(
                                "${tr(LocaleKeys.additionText_repeat)} : ${petProvider.editpetRepeatEvent.text}",
                                // "${dateConverter2(DateTime.fromMillisecondsSinceEpoch(int.parse(enventDateee,),isUtc: true))}",
                                textAlign: TextAlign.left,
                                style: const TextStyle(
                                    fontSize: 15.0,
                        ...
                        : Row(
                            children: [
                              ...
                              SizedBox(
                                width: MediaQuery.of(context).size.width * .85,
                                child: Text(
                                  "${tr(LocaleKeys.additionText_reminderBefore)}  : ${petProvider.editRemindBefor.text}",
                                  // petProvider.selectedEvent?.eventName ?? "",
                                  maxLines: 5,
                                  softWrap: true,
                                  textAlign: TextAlign.left,
